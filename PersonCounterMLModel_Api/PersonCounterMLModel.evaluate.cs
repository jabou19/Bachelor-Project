...
namespace PersonCounterMLModel_Api
{
    public partial class PersonCounterMLModel
    {
        ...
        public static double CalculateRSquaredOnTrainingDataPersonCounter(MLContext mlContext, ITransformer model, IDataView trainingData)
        {
            ...
            var metrics = mlContext.Regression.Evaluate(predictions, labelColumnName: "personCount", scoreColumnName: "Score");
