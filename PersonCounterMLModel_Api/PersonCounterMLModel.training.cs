...
namespace PersonCounterMLModel_Api
{
    ...
    public partial class PersonCounterMLModel
    {
        public const string RetrainFilePath =
            @"C:\Users\jakub\Skrivebord\semester 7\projectCode\project\Bachelor-Project\Backend\Files\CVS\peopleCounterFiltered.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.ReplaceMissingValues(new[]
                {
                    new InputOutputColumnPair(@"rssi", @"rssi"),
                    new InputOutputColumnPair(@"batteryLevel", @"batteryLevel"),
                    new InputOutputColumnPair(@"seqNumber", @"seqNumber")
                })
                ...
                .Append(mlContext.Transforms.Concatenate(@"Features",
                    new[] { @"rssi", @"batteryLevel", @"seqNumber", @"networkId", @"time", @"createdAt" }))
                .Append(mlContext.Regression.Trainers.FastForest(new FastForestRegressionTrainer.Options()
                {
                    NumberOfTrees = 5, NumberOfLeaves = 40, FeatureFraction = 1F, LabelColumnName = @"personCount",
